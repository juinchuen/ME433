...
void ssd1306_writeChar(unsigned char x, unsigned char y, char data){
    
    unsigned char index = ((unsigned char)data) - 32;
...
void ssd1306_writeString(unsigned char x, unsigned char y, char* data){

    int index = 0;
    
    while (data[index] != '\0'){
    
        ssd1306_writeChar(x + index * 5, y, data[index]);
